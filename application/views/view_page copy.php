<style>
.row {
    overflow: scroll; /* Prevents overflow of zoomed images */
}
...
.project_img:hover {
    transform: scale(8.1); /* Scale image to 110% on hover */
}
            ...
            <div class="row">
                <?php foreach ($project as $image): // Loop through the images array ?>
                    <div class="col-lg-2 col-md-2 col-sm-6 col-4">
                        <a href="<?php echo base_url()?>projects/view_image"><input type="hidden" id="id" name="id" value="<?php echo $image['image_id']?>"><img class="project_img" src="<?= base_url() ?>assets/images/<?= $image['image'] ?>" alt="Project Image"></a>
                    </div>
                    <br><br><br>
                <?php endforeach; ?>
            </div>
